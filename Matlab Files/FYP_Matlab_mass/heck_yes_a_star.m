function WAYPOINT = heck_yes_a_star(NODES, POSITION, TARGET, OBSERVED_SET, PROX)
...
%         pause(0.0001);
        ...
        for i = 1:4
            ...
            heuristic = norm(NEIGHBOUR(1:2) - TARGET)*2 + 100*near_obstacles(NEIGHBOUR(1:2), OBSERVED_SET, PROX);

function [TARGET, OBSTACLE, INITIAL] = interactive(MAX_X, MAX_Y, PULL_OR_RERUN)
    ...
    if PULL_OR_RERUN
        load('A:\Users\Tai\Desktop\FYP_Matlab\map_saves\initial.mat', 'INITIAL');
        load('A:\Users\Tai\Desktop\FYP_Matlab\map_saves\obstacle.mat', 'OBSTACLE');
        load('A:\Users\Tai\Desktop\FYP_Matlab\map_saves\target.mat', 'TARGET');
    else
        j=0;
        x_val = 1;
        y_val = 1;
        ...
        while but == 1
            ...
            plot(OBSTACLE(n, 1), OBSTACLE(n, 2), 'ro'); % red colour O
        end
        ...
        % save stuff
        save('A:\Users\Tai\Desktop\FYP_Matlab\map_saves\initial.mat', 'INITIAL');
        save('A:\Users\Tai\Desktop\FYP_Matlab\map_saves\obstacle.mat', 'OBSTACLE');
        save('A:\Users\Tai\Desktop\FYP_Matlab\map_saves\target.mat', 'TARGET');
    end
